							...
							<div class="row p-5">
								...
								<div class="col-8">
									<input type="text" id="jobNo" name="jobNo" class="form-control"
										readonly="readonly" value="${jobVo.jobNo}">
								</div>
							</div>
							<div class="row p-5">
								<div class="col-2">
								...
								<div class="col-8">
									<input type="text" id="jobName" name="jobName"
										class="form-control" value="${jobVo.jobName}">
								</div>
							</div>
						</div>
					</form>
			...
			<div class="mt-4">
				<div class="offset-9">
					<input type="button" class="btn btn-outline-primary"
						id="btn_submit" name="btn_submit" value="수정"> <input
						type="button" class="btn btn-outline-dark"
						onclick="location.href='./read?jobNo=${jobVo.jobNo}'" value="취소">
				</div>
			</div>
		</div>
	</div>
