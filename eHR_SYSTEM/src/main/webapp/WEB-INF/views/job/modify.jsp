...
<div id="layoutSidenav_content">
   <main>
	   <div class="container-fluid px-4">
	      <h1 class="mt-4" style='text-align: left; margin-bottom: 30px;'>직종 수정</h1>
				<div class="container-fluid px-5">
                        ...
                        <div class="mt-4">
		                    	...
		                    	<input type="button" class="btn btn-outline-dark" onclick="location.href='./read?jobNo=${jobVo.jobNo}'" value="취소">
		                	</div>
                        </div>      
               		</div>
           	 	</div>              
