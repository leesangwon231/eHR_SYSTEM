			...
			<form role="form" method="post" name="frm">
				...
				<div class="row pt-5 ">
					<table id="datatablesSimple" class="dataTable-table">
						...
						<tbody>
							<c:forEach items="${sList}" var="sVo" varStatus="status">
								<input type="hidden" name="jnLIst[${status.index}].sNo" id="sNo"
									value="${sVo.sNo}">
								<tr>
									<td>${sVo.sName}</td>
									...
									<td>
										<%-- <div id='mydropzone' class="dropzone">
											<input type="file" id="fileUpload"
												name="<c:url value='jnLIst[${status.index}].'/>fileUpload"
											...
											<div class="fileDrop">
												...
												<div class="input-group">
													...
													<!-- <div class="card">
														<ul
															class="dropzone-previews clearfix uploadedList preview-list"></ul>
													</div> -->
												</div>
											</div>
										</div>
				...
				<div class="mt-4">
					<div class="offset-9" align="right">
						<input type="button" class="btn btn-primary" id="btn_submit"
							...
							class="btn btn-primary" onclick="location.href='/journal/list'"
							value="취소">
					</div>
				</div>
			</form>
