	      ...
	      <div class="card mb-4">
	         <div class="card-header">
	            <i class="bi bi-megaphone"></i> 직원 목록
	            	<button class="btn btn-outline-dark btn-sm" id="newBtn" style="float: right; padding: 0 auto 0 auto;">직원 등록</button>
	         </div>
	         <div class="card-body">
	               ...
	               <tbody>
	                  <c:forEach items="${list}" var="MemberVO" varStatus="status">
	                     <tr>
	                        ...
	                        <td><fmt:formatDate pattern="yyyy-MM-dd" value="${MemberVO.memHiredate}"/></td>
	                     </tr>
	                  </c:forEach>
	               </tbody>
	            </table>
