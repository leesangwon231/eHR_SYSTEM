...
<div id="layoutSidenav_content">
   <main>
	   <div class="container-fluid px-4">
	      <h1 class="mt-4" style='text-align: left; margin-bottom: 30px;'>소분류 상세보기</h1>
								...
								<form role="form" method="post" name="frm">
			                        <div class="col-lg-10">
			                        	<div class="row p-5">
		                        			...
		                        			<div class="col-9">
		                        				<input type="text" id = "jgName" name="jgName" class = "form-select" readonly="readonly" value="${scategoryVO.jgName}">
				                        	</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-1">
		                        			...
		                        			<div class="col-9">
		                        				<input type="text" id = "jobName" name="jobName" class = "form-select" readonly="readonly" value="${scategoryVO.jobName}">
				                        	</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-2">
		                        			...
		                        			<div class="col-8">
				                        		<input type="text" id = "lName" name="lName" class = "form-select" readonly="readonly" value="${scategoryVO.lName}">
				                        	</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-2">
		                        			...
		                        			<div class="col-8">
				                       			<input type="text" id = "sNo" name="sNo" class = "form-select" readonly="readonly" value="${scategoryVO.sNo}">
				                       		</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-2">
		                        			...
		                        			<div class="col-8">
				                       			<input type="text" id = "sName" name="sName" class = "form-select" readonly="readonly" value="${scategoryVO.sName}">
				                       		</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-2">
		                        			...
		                        			<div class="col-3">
				                       			<input type="text" id = "sYear" name="sYear" class = "form-select" readonly="readonly" value="${scategoryVO.sYear}">
				                       		</div>
				                       		<div class="col-2">
				                        		<label for="exampleInputEmail1">월</label>
				                        	</div>
		                        			<div class="col-3">
				                       			<input type="text" id = "sMonth" name="sMonth" class = "form-select" readonly="readonly" value="${scategoryVO.sMonth}">
				                       		</div>
			                        	</div>
			                        	...
			                        	<div class="row p-5">
		                        			...
		                        			<div class="col-3">
				                       			<input type="text" id = "sQuarter" name="sQuarter" class = "form-select" readonly="readonly" value="${scategoryVO.sQuarter}">
				                       		</div>
		                        			...
		                        			<div class="col-3">
				                       			<input type="text" id = "sDay" name="sDay" class = "form-select" readonly="readonly" value="${scategoryVO.sDay}">
				                       		</div>
			                        	</div>
