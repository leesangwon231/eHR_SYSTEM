...
<div id="layoutSidenav_content">
   <main>
	   <div class="container-fluid px-4">
	      <h1 class="mt-4" style='text-align: left; margin-bottom: 30px;'>소분류 등록</h1>
								...
								<form role="form" method="post" name="frm" >
			                        <div class="col-lg-10">
			                        	<div class="row p-5">
		                        			...
		                        			<div class="col-9">
				                        		<select name="jgName" id="jgName" class = "form-select" onchange="selectJobGroup(value);">
			                        	...
			                        	<div class="row p-5">
		                        			...
		                        			<div class="col-9">
				                        		<select name="jobName" id="jobName" class = "form-select" onchange="selectLcategory(value)">
			                        	...
			                        	<div class="row p-5">
		                        			...
		                        			<div class="col-8">
				                        		<input type="text" id = "sNo" name="sNo" class = "form-select" readonly="readonly" value= 1>
				                        	</div>
			                        	</div>
			                        	<div class="row p-5">
				                        	<div class="col-2">
				                        		<label for="exampleInputEmail1">소분류 명</label>
				                        	</div>
		                        			<div class="col-8">
